...
import cl.duoc.bankxyz.migracion.services.TransaccionJobService;
import lombok.RequiredArgsConstructor;

/**
 * Endpoint REST para disparar manualmente el Job "transaccionesJob"
 * (Proceso 1: Reporte de Transacciones Diarias). Se prueba con Postman:
 *
...
public class TransaccionJobController {

    private final TransaccionJobService transaccionJobService;

    @PostMapping("/procesar")
    public ResponseEntity<Map<String, Object>> procesar() {
        JobExecution execution = transaccionJobService.ejecutar();
